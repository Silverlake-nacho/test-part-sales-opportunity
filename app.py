...
<head>
  ...
  <style>
    ...
    .btn-primary {
      background-color: #b5d194; /* background fields? */
      border: none;
    }
  </style>
</head>
  ...
  <body class="p-4">
    <div class="container">
      ...
      <form method="post">
        ...
        <button type="submit" class="from flask import Flask, request, render_template_string, send_file, redirect, url_for, session
import pandas as pd
from io import BytesIO
